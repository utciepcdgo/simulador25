                ...
                <div class="col-span-2 flex-row space-y-10">                  
                    <div class="bg-gray-200 p-4 my-4 dark:bg-gray-800 dark:text-white rounded-md" data-block="1" data-blocktype="electoral_block">
                        ...
                        <h2 id="accordion-collapse-heading-1" class="mb-2.5">
                            <button type="button" class="flex items-center justify-between w-full bg-white p-3 rounded dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3 shadow-2xl"
