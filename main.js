...
// console.log(Blocks);
	...
	window.addEventListener('change', (El) => {
		...
		console.log(Math.ceil(parseInt(Blocks[_.toString(parseInt(partySelectorEl.value) - 1)].number_districts) / 2))

		if (_c__general_females === Math.ceil(_e__nums_positions / 2) && _c__general_males === Math.floor(_e__nums_positions / 2)) document.querySelector('._c__general').classList.replace('text-gray-400', 'text-green-400')
		else document.querySelector('._c__general').classList.replace('text-green-400', 'text-gray-400')

		if (_c__general_males === Math.ceil(_e__nums_positions / 2) && _c__general_females === Math.floor(_e__nums_positions / 2)) document.querySelector('._c__general').classList.replace('text-gray-400', 'text-green-400')
		else document.querySelector('._c__general').classList.replace('text-green-400', 'text-gray-400')
		...
		_c_result = _.some(_c__check_array, function (e) { return e !== 1})
