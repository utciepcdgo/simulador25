            ...
            <div class="grid w-full gap-6 md:grid-cols-3 grid-flow-row-dense auto-cols-max hover:auto-cols-min">
                <div>
					...
					<ul class="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-400 sticky top-0">
						...
						<li class="flex items-center">
							<svg class="w-3.5 h-3.5 me-2 flex-shrink-0 _c__three" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
								<path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"/>
							 </svg>
                       ...
                       _HTML__content += '<div class="bg-gray-200 p-4 my-4 dark:bg-gray-800 dark:text-white rounded-md" data-block="'+ key +'" data-blocktype="electoral_block">'
                        ...
                        for (const [index, district] of block[key].districts.entries()) {
                            ...
                            _HTML__content += '<h2 id="accordion-collapse-heading-'+ district.uuid +'" class="mb-2.5">'
                                ...
                                +'                </li>'
                                +'                <li class="col-span-2">'
                                +'                   <input type="radio" id="pride-'+ district.uuid +'-p" name="'+ district.uuid +'-p" data-position="p" data-block="'+ key +'" data-level="'+ (index + 1) +'" data-uuid="'+ district.uuid +'" value="g5" class="hidden peer">'
                                +'                   <label for="pride-'+ district.uuid +'-p" class="inline-flex overflow-hidden relative items-center justify-between w-full p-5 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">'
                                +'                        <div class="block">'
